...
def generate_launch_description():
    ...
    pkg_my_world = get_package_share_directory('gazebo_example') # TODO: your package name
    ...
    # World file path
    world = os.path.join(pkg_my_world, 'worlds', 'lab2_task4.world') # TODO: fill the name of your cutom world
