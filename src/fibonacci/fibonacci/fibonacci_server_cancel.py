...
class FibonacciServerNode(Node):
    def __init__(self):
        ...
        self.action_server_ = ActionServer(self, Fibonacci, 'fibonacci_cancel', # TODO: fill with the action name
    ...
    def execute_callback(self, goal_handle):
        ...
        for i in range(1, order):
            ...
            if goal_handle.is_cancel_requested:
                ...
                self.get_logger().info('fibonacci action server has been canceled!') # TODO: Filled with a mesage for the cancellation
